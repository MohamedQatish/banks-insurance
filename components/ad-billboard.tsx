...
const slides = [
  ...
  },
  {
    ...
    category: "تكنولوجيا", // أو 'موبايلات' حسب قائمة التصنيفات المعتمدة لديك
    ...
    cta: "اعرف المزيد",
    categoryColor: "#c9a227", // يمكنك الإبقاء على نفس اللون أو تغييره إلى '#1a1a1a' ليتماشى مع ثيم الصورة الداكن
  },
];
      ...
      {slides.map((s, i) => (
        ...
        >
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(to left, rgba(6,14,26,0.5) 0%, transparent 55%)",
            }}
            aria-hidden="true"
          />
        </div>
