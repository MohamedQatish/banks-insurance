    ...
    if (line.startsWith('## ')) {
      elements.push(
        <h2
          ...
          style={{ color: '#0a1628', borderRight: '4px solid #c9a227', paddingRight: '12px' }}
        >
          {line.slice(3)}
        </h2>
      )
...
function renderInline(text: string): string {
  return text
    .replace(/\*\*(.+?)\*\*/g, '<strong style="color:#0a1628;font-weight:700">$1</strong>')
...
export default async function NewsDetailPage({
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: '#f0f4f8', direction: 'rtl' }}>
      ...
      >
        <ol className="flex items-center gap-2 text-xs flex-wrap" style={{ color: '#8a9bb8' }}>
          <li>
          ...
          <li aria-hidden="true"><ChevronLeft size={12} /></li>
          <li className="line-clamp-1 max-w-[200px]" style={{ color: '#c9a227' }} aria-current="page">
            {article.title}
          </li>
        </ol>
      </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          >
            ...
            <div className="p-6 md:p-8">
              {/* Meta row */}
              <div className="flex flex-wrap items-center gap-4 mb-5 text-xs" style={{ color: '#8a9bb8' }}>
              ...
              <div
                ...
                style={{ borderTop: '1px solid #cfd8e6' }}
              >
                <span className="flex items-center gap-2 text-sm font-bold" style={{ color: '#0a1628' }}>
                  <Share2 size={16} style={{ color: '#c9a227' }} aria-hidden="true" />
                  مشاركة الخبر
                </span>
          ...
          <aside aria-label="أخبار ذات صلة">
            <div className="sticky top-[80px] flex flex-col gap-6">
              ...
              >
                ...
                {related.length === 0 ? (
                  <p className="text-sm" style={{ color: '#8a9bb8' }}>لا توجد أخبار ذات صلة حالياً.</p>
                ) : (
              ...
              <Link
                ...
                style={{ background: '#0a1628', color: '#c9a227', border: '1px solid rgba(201,162,39,0.3)' }}
              >
